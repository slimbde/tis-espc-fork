...
namespace Mascix.SQLiteProviders
{
    public sealed class SQLiteProfileProvider : ProfileProvider
    {
                ...
                {//read data
                    ...
                    { // User exists?
                        ...
                        /*try { // Not a critical part -- don't throw exceptions here
                            read = new SQLiteCommand("UPDATE users SET LastActivityDate='" + DateTime.Now.ToString("yyyy:MM:dd hh:mm:ss") + "' WHERE PKID ='" + PKID + "'", holder);
        ...
        {
            int appId = GetApplicationId(new SQLiteConnection(_connectionString));
            string sqlQuery = "SELECT COUNT(*) FROM users u, aspnet_Profile read " +
              "WHERE ApplicationId ='" + appId + "' AND LastActivityDate <= '" + userInactiveSinceDate.ToString("yyyy:MM:dd hh:mm:ss") + "' AND u.PKID = read.PKID" + GetClauseForAuthenticationOptions(authenticationOption);
            SQLiteConnection conn = new SQLiteConnection(_connectionString);
            int Result;
            try
            {
        ...
        {
            int appId = GetApplicationId(new SQLiteConnection(_connectionString));
            string sqlQuery = "SELECT u.UserName, u.IsAnonymous, u.LastActivityDate, read.LastUpdatedDate, LEN(read.PropertyNames) + LEN(read.PropertyValuesString) FROM users u, aspnet_Profile read WHERE ApplicationId ='" + appId + "' AND u.PKID = read.PKID " + GetClauseForAuthenticationOptions(authenticationOption);
        ...
        {
            int appId = GetApplicationId(new SQLiteConnection(_connectionString));
            string sqlQuery = "SELECT u.UserName, u.IsAnonymous, u.LastActivityDate, read.LastUpdatedDate, LEN(read.PropertyNames) + LEN(read.PropertyValuesString) FROM users u, aspnet_Profile read WHERE ApplicationId ='" + appId + "' AND u.PKID = read.PKID AND u.LastActivityDate <= '" + userInactiveSinceDate.ToString("yyyy:MM:dd hh:mm:ss") + "' " + GetClauseForAuthenticationOptions(authenticationOption);
            SQLiteParameter[] args = new SQLiteParameter[0];
            return GetProfilesForQuery(sqlQuery, args, pageIndex, pageSize, out totalRecords);
        }
        ////////////////////////////////////////////////////////
        ...
        public override ProfileInfoCollection FindProfilesByUserName(ProfileAuthenticationOption authenticationOption, string usernameToMatch, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            int appId = GetApplicationId(new SQLiteConnection(_connectionString));
            string sqlQuery = "SELECT u.UserName, u.IsAnonymous, u.LastActivityDate, read.LastUpdatedDate, LEN(read.PropertyNames) + LEN(read.PropertyValuesString) FROM users u, aspnet_Profile read WHERE ApplicationId ='" + appId + "' AND u.PKID = read.PKID AND u.UserName LIKE '" + usernameToMatch + "'" + GetClauseForAuthenticationOptions(authenticationOption);
            SQLiteParameter[] args = new SQLiteParameter[0];
            return GetProfilesForQuery(sqlQuery, args, pageIndex, pageSize, out totalRecords);
        }
        ...
        public override ProfileInfoCollection FindInactiveProfilesByUserName(ProfileAuthenticationOption authenticationOption, string usernameToMatch, DateTime userInactiveSinceDate, int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            int appId = GetApplicationId(new SQLiteConnection(_connectionString));
            string sqlQuery = "SELECT u.UserName, u.IsAnonymous, u.LastActivityDate, read.LastUpdatedDate, LEN(read.PropertyNames) + LEN(read.PropertyValuesString) FROM users u, aspnet_Profile read WHERE ApplicationId ='" + appId + "' AND u.PKID = read.PKID AND u.UserName like '" + usernameToMatch + "' AND u.LastActivityDate <='" + userInactiveSinceDate.ToString("yyyy:MM:dd hh:mm:ss") + "'" + GetClauseForAuthenticationOptions(authenticationOption);
            SQLiteParameter[] args = new SQLiteParameter[0];
            return GetProfilesForQuery(sqlQuery, args, pageIndex, pageSize, out totalRecords);
        }
